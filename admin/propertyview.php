									...
									?>
										...
										<tr>
											...
											<td><a href="propertydetails.php?id=<?php echo $row['0']; ?>"><button class="btn btn-success">View</button></a>
												...
												<a href="#"><button class="btn btn-danger deleteproperty" data-property-id="<?php echo $row['0']; ?>">Delete</button></a>
											</td>
										</tr>
									<?php
									}
...
<script>
	$(document).ready(function() {
		$(document).on("click", ".deleteproperty", function() {
			const propid =$(this).attr("data-property-id");
			if(confirm("Are you sure you want to delete this property?\n this will delete the allocation also.")) {
				$.ajax({
				...
				success: function(data) {
					window.location.href="propertyview.php?msg="+data
				}
			});
			}
