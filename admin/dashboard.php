					...
					<div class="card">
						<div class="card-body">
							...
							<div class="dash-widget-info">
								...
								<h3> $sql = "SELECT * FROM user WHERE utype = 'agent'";
									$query = $con->query($sql);
									echo "$query->num_rows"; ?></h3>
				...
				<!-- <div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3> $sql = "SELECT * FROM user WHERE utype = 'builder'";
										$query = $con->query($sql);
                						echo "$query->num_rows";</h3>
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="dash-widget-info">
								...
								<h3><?php $sql = "SELECT * FROM property where stype = 'allocation'";
									$query = $con->query($sql);
									echo "$query->num_rows"; ?></h3>

								<h6 class="text-muted">For Allocation</h6>
								<div class="progress progress-sm">
									<div class="progress-bar bg-info w-50"></div>
								</div>
							</div>
