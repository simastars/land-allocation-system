...
if(isset($_POST['add']))
{
	...
	$sql = "UPDATE property SET title= '{$title}', pcontent= '{$desc}', type='{$ptype}', bhk='{$bhk}', stype='{$stype}',
	bedroom='{$bed}',size='{$asize}', price='{$price}', location='{$loc}', city='{$city}', state='{$state}', feature='{$feature}',
										...
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea class="tinymce form-control" name="desc" rows="10" cols="30"><?php echo $row['2']; ?></textarea>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="aimage" type="file" required="" value="<?php echo $row['18'];?>">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="aimage2" type="file" required="" value="<?php echo $row['20'];?>">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="aimage1" type="file" required="" value="<?php echo $row['19'];?>">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input class="form-control" name="aimage3" type="file" required="" value="<?php echo $row['21'];?>">
