...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", ".deleterenter", function() {
            let id = $(this).attr("data-rent-id");
            if (confirm("Are you sure you want to delete this Person?\n this will delete their allocation also.")) {
                $.ajax({
                    url: "dodeleterenter.php",
                    method: "POST",
                    type: "text",
                    data: {
                        id: id
                    ...
                    success: function(data) {
                        ...
                        if (data == "ok") {
                            ...
                            alert("there was an erro in deleting this person")
                        }
                    }
                })
            }
